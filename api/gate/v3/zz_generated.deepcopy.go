...
func (in *ControllerConfSpec) DeepCopyInto(out *ControllerConfSpec) {
	*out = *in
	...
	if in.HaproxyGlobal != nil {
		in, out := &in.HaproxyGlobal, &out.HaproxyGlobal
		*out = new(HaproxyGlobal)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HaproxyGlobal) DeepCopyInto(out *HaproxyGlobal) {
	*out = *in
	if in.LogLineLength != nil {
		in, out := &in.LogLineLength, &out.LogLineLength
		*out = new(int64)
		**out = **in
	}
	if in.HTTPLogURILen != nil {
		in, out := &in.HTTPLogURILen, &out.HTTPLogURILen
		*out = new(int64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HaproxyGlobal.
func (in *HaproxyGlobal) DeepCopy() *HaproxyGlobal {
	if in == nil {
		return nil
	}
	out := new(HaproxyGlobal)
