...
type HostnamesMatchtypeSuite18 struct {
	base.BaseSuite
}
...
func (s *HostnamesMatchtypeSuite18) SetupSuite() {
	s.BaseSuite.SetupSuite("../", 0)
}

func (s *HostnamesMatchtypeSuite18) TearDownSuite() {
