...
type HostnamesMatchtypeSuite9 struct {
	base.BaseSuite
}
...
func (s *HostnamesMatchtypeSuite9) SetupSuite() {
	s.BaseSuite.SetupSuite("../", 0)
}

func (s *HostnamesMatchtypeSuite9) TearDownSuite() {
